...
#if defined(__STDC_VERSION__) && (__STDC_VERSION__ >= 199901L) && !(defined(__ICL) && defined(_WIN32))
#  include <inttypes.h>
...
#if defined(__GNUC__)
#  define DSFMT_PRE_INLINE static inline
 ...
 */
static inline uint32_t dsfmt_genrand_uint32(dsfmt_t *dsfmt) {
    uint32_t r;
 ...
 * @return double precision floating point pseudorandom number
 */
static inline double dsfmt_genrand_close1_open2(dsfmt_t *dsfmt) {
    double r;
 ...
 * @return double precision floating point pseudorandom number
 */
static inline uint32_t dsfmt_gv_genrand_uint32(void) {
 ...
 * @return double precision floating point pseudorandom number
 */
static inline double dsfmt_gv_genrand_close1_open2(void) {
 ...
 * @return double precision floating point pseudorandom number
 */
static inline double dsfmt_genrand_close_open(dsfmt_t *dsfmt) {
 ...
 * @return double precision floating point pseudorandom number
 */
static inline double dsfmt_gv_genrand_close_open(void) {
 ...
 * @return double precision floating point pseudorandom number
 */
static inline double dsfmt_genrand_open_close(dsfmt_t *dsfmt) {
 ...
 * @return double precision floating point pseudorandom number
 */
static inline double dsfmt_gv_genrand_open_close(void) {
 ...
 * @return double precision floating point pseudorandom number
 */
static inline double dsfmt_genrand_open_open(dsfmt_t *dsfmt) {
 ...
 * @return double precision floating point pseudorandom number
 */
static inline double dsfmt_gv_genrand_open_open(void) {
 ...
 */
static inline void dsfmt_gv_fill_array_close1_open2(double array[], int size) {
 ...
 */
static inline void dsfmt_gv_fill_array_open_close(double array[], int size) {
 ...
 * dsfmt_gv_fill_array_close1_open2()
 */
static inline void dsfmt_gv_fill_array_close_open(double array[], int size) {
 ...
 * dsfmt_gv_fill_array_close1_open2()
 */
static inline void dsfmt_gv_fill_array_open_open(double array[], int size) {
 ...
 */
static inline void dsfmt_init_gen_rand(dsfmt_t *dsfmt, uint32_t seed) {
 ...
 */
static inline void dsfmt_gv_init_gen_rand(uint32_t seed) {
 ...
 */
static inline void dsfmt_init_by_array(dsfmt_t *dsfmt, uint32_t init_key[],
				       int key_length) {
 ...
 */
static inline void dsfmt_gv_init_by_array(uint32_t init_key[], int key_length) {
 ...
 */
static inline int get_min_array_size(void) {
 ...
 */
static inline void init_gen_rand(uint32_t seed) {
 ...
 */
static inline void init_by_array(uint32_t init_key[], int key_length) {
 ...
 */
static inline double genrand_close1_open2(void) {
 ...
 */
static inline double genrand_close_open(void) {
 ...
 */
static inline double genrand_open_close(void) {
 ...
 */
static inline double genrand_open_open(void) {
 ...
 * dsfmt_gv_fill_array_close1_open2()
 */
static inline void fill_array_open_close(double array[], int size) {
 ...
 * dsfmt_gv_fill_array_close1_open2()
 */
static inline void fill_array_close_open(double array[], int size) {
 ...
 * dsfmt_gv_fill_array_close1_open2()
 */
static inline void fill_array_open_open(double array[], int size) {
 ...
 * dsfmt_gv_fill_array_close1_open2()
 */
static inline void fill_array_close1_open2(double array[], int size) {
