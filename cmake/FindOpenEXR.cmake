...
FIND_RELEASE_AND_DEBUG(HALF NAMES Half DEFAULT_SUFFIXES
  PATHS ${OPENEXR_ROOT_DIR})
FIND_RELEASE_AND_DEBUG(IEX NAMES Iex DEFAULT_SUFFIXES
  PATHS ${OPENEXR_ROOT_DIR})
FIND_RELEASE_AND_DEBUG(IMATH NAMES Imath DEFAULT_SUFFIXES
  PATHS ${OPENEXR_ROOT_DIR})
FIND_RELEASE_AND_DEBUG(ILMTHREAD NAMES IlmThread DEFAULT_SUFFIXES
  PATHS ${OPENEXR_ROOT_DIR})
FIND_RELEASE_AND_DEBUG(ILMIMF NAMES IlmImf DEFAULT_SUFFIXES
  PATHS ${OPENEXR_ROOT_DIR})
