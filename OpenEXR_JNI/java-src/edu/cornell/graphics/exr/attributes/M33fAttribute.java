...
/**
 * A {@code TypedAttribute} subclass holding a {@code Matrix33<Float>} value.
 * 
 * @since OpenEXR-JNI 2.1
 */
public final class M33fAttribute extends TypedAttribute<Matrix33<Float>> {
    
    public M33fAttribute() {
        // empty
    }
    
    public M33fAttribute(Matrix33<Float> value) {
        super(value);
    }
